        ...
        <section id="contact" style={{ textAlign: 'center', background: 'var(--bg-secondary)', borderTop: '1px solid var(--border-color)', padding: '4rem 0' }}>
          <div className="container">
            ...
            <div style={{ marginBottom: '3rem' }}>
              <a href="mailto:sayam.230713@gmail.com" style={{ background: 'var(--gradient-primary)', padding: '1rem 2.5rem', borderRadius: '30px', fontWeight: 600, color: 'white', display: 'inline-block', boxShadow: '0 4px 15px rgba(59, 130, 246, 0.4)', margin: '0.5rem' }}>
                Email Me
              </a>
              <a href="tel:+8801614178672" style={{ background: 'rgba(255, 255, 255, 0.05)', border: '1px solid var(--border-color)', padding: '1rem 2.5rem', borderRadius: '30px', fontWeight: 600, color: 'white', display: 'inline-block', margin: '0.5rem', transition: 'all 0.3s ease' }}>
                +880 1614-178672
              </a>
            </div>
