  ...
  const skillCategories = [
    {
      ...
      skills: ['Python', 'C++', 'SQL', 'Bash', 'FastAPI', 'PostgreSQL', 'Redis', 'API Design', 'Software Engineering']
    },
    {
      title: 'Scientific & Data',
      skills: ['NumPy', 'Pandas', 'xarray', 'Numba JIT', 'CERN ROOT', 'Geant4', 'uproot', 'Monte Carlo']
    },
    {
      title: 'Frontend',
    ...
    {
      title: 'Cloud & DevOps',
      skills: ['Linux/Ubuntu', 'Docker', 'Terraform', 'GCP', 'GitHub Actions', 'CI/CD', 'Prometheus', 'Grafana']
    }
  ];
